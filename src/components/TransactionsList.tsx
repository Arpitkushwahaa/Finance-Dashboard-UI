        ...
        <div className="flex flex-wrap gap-4 w-full md:w-auto">
          <div className="relative flex-1 sm:w-64">
            ...
            <input
              ...
              className="w-full pl-9 pr-4 py-2 bg-transparent dark:bg-slate-900 border border-input rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary text-black dark:text-white placeholder:text-muted-foreground"
              value={searchTerm}
              onChange={(e) => setSearchTerm(e.target.value)}
            />
          </div>
          <select
            className="px-4 py-2 bg-transparent dark:bg-slate-900 border border-input rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary text-black dark:text-white"
            value={filterType}
            onChange={(e) => setFilterType(e.target.value as any)}
          >
            <option className="dark:bg-slate-900 dark:text-white bg-white text-black" value="all">All Types</option>
            <option className="dark:bg-slate-900 dark:text-white bg-white text-black" value="income">Income</option>
            <option className="dark:bg-slate-900 dark:text-white bg-white text-black" value="expense">Expense</option>
          </select>
          <select
            className="px-4 py-2 bg-transparent dark:bg-slate-900 border border-input rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary text-black dark:text-white"
            value={sortBy}
          ...
          >
            <option className="dark:bg-slate-900 dark:text-white bg-white text-black" value="date">Sort by Date</option>
            <option className="dark:bg-slate-900 dark:text-white bg-white text-black" value="amount">Sort by Amount</option>
          </select>
          <button 
            ...
            <form onSubmit={handleAddSubmit} className="space-y-4">
              <div>
                ...
                <input 
                  ...
                  className="w-full px-4 py-2 bg-transparent dark:bg-slate-900 border border-input rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary text-black dark:text-white placeholder:text-muted-foreground" 
              ...
              <div className="grid grid-cols-2 gap-4">
                 ...
                 <div>
                    ...
                    <input 
                      ...
                      className="w-full px-4 py-2 bg-transparent dark:bg-slate-900 border border-input rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary text-black dark:text-white" 
                    />
                 </div>
              </div>
              <div>
