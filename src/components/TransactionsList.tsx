        ...
        <div className="flex flex-wrap gap-4 w-full md:w-auto">
          <div className="relative flex-1 sm:w-64">
            ...
            <input
              ...
              className="w-full pl-9 pr-4 py-2 bg-transparent border border-input rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary text-foreground placeholder:text-muted-foreground"
              value={searchTerm}
              onChange={(e) => setSearchTerm(e.target.value)}
            />
          </div>
          <select
            className="px-4 py-2 bg-transparent border border-input rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary text-foreground"
            value={filterType}
            onChange={(e) => setFilterType(e.target.value as any)}
          >
            <option className="bg-background text-foreground" value="all">All Types</option>
            <option className="bg-background text-foreground" value="income">Income</option>
            <option className="bg-background text-foreground" value="expense">Expense</option>
          </select>
          <select
            className="px-4 py-2 bg-transparent border border-input rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary text-foreground"
            value={sortBy}
          ...
          >
            <option className="bg-background text-foreground" value="date">Sort by Date</option>
            <option className="bg-background text-foreground" value="amount">Sort by Amount</option>
          </select>
          <button 
            ...
            <form onSubmit={handleAddSubmit} className="space-y-4">
              <div>
                ...
                <input 
                  ...
                  className="w-full px-4 py-2 bg-transparent border border-input rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary text-foreground placeholder:text-muted-foreground" 
              ...
              <div className="grid grid-cols-2 gap-4">
                 ...
                 <div>
                    ...
                    <input 
                      ...
                      className="w-full px-4 py-2 bg-transparent border border-input rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary text-foreground" 
                    />
                 </div>
              </div>
              <div>
